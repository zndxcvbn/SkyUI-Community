class skyui.util.EffectIconMap
{
    ...
    public static function lookupIconLabel(a_effectData: Object)
    {
        ...
        var baseLabel = skyui.util.EffectIconMap._archetypeMap[archetype];
        ...
        switch (archetype) {
            ...
            case skyui.defines.Magic.ARCHETYPE_PEAKVALUEMOD:
                var isDetrimental = a_effectData.effectFlags & skyui.defines.Magic.MGEFFLAG_DETRIMENTAL;
                var isRecovering = a_effectData.effectFlags & skyui.defines.Magic.MGEFFLAG_RECOVER;
        ...
        // Lookup base icon
        baseLabel = skyui.util.EffectIconMap._avMap[actorValue];
